 ...
 * state.
 */
class MaterialCheckedTextView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        val a = context.obtainStyledAttributes(
            attrs,
            R.styleable.MaterialCheckedTextView,
            R.attr.MaterialCheckedTextViewStyle,
            R.style.Widget_MaterialCheckedTextView
        )
        outlinePaint = Paint(ANTI_ALIAS_FLAG).apply {
            color = a.getColorOrThrow(R.styleable.MaterialCheckedTextView_android_strokeColor)
            strokeWidth = a.getDimensionOrThrow(R.styleable.MaterialCheckedTextView_outlineWidth)
            style = STROKE
        }
        defaultTextColor = a.getColorOrThrow(R.styleable.MaterialCheckedTextView_android_textColor)
        textPaint = TextPaint(ANTI_ALIAS_FLAG).apply {
            color = defaultTextColor
            textSize = a.getDimensionOrThrow(R.styleable.MaterialCheckedTextView_android_textSize)
        }
        dotPaint = Paint(ANTI_ALIAS_FLAG)
        clear = a.getDrawableOrThrow(R.styleable.MaterialCheckedTextView_clearIcon).apply {
            setBounds(
                -intrinsicWidth / 2, -intrinsicHeight / 2, intrinsicWidth / 2, intrinsicHeight / 2
            )
        }
        touchFeedback = a.getDrawableOrThrow(R.styleable.MaterialCheckedTextView_foreground).apply {
            callback = this@MaterialCheckedTextView
        }
        padding = a.getDimensionPixelSizeOrThrow(R.styleable.MaterialCheckedTextView_android_padding)
        isChecked = a.getBoolean(R.styleable.MaterialCheckedTextView_android_checked, false)
        showIcons = a.getBoolean(R.styleable.MaterialCheckedTextView_showIcons, true)
        a.recycle()
        clipToOutline = true
    }
